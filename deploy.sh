#!/usr/bin/env bash
# =============================================================================
# Awesome.ai — Interactive Deployment Wizard
# =============================================================================
set -euo pipefail
IFS=$'\n\t'
...
_banner() {
  ...
  echo -e "${ACCENT}  │${RESET}       ${DIM}Tennessee Tech  ·  Deployment Wizard${RESET}          ${ACCENT}│${RESET}"
  echo -e "${ACCENT}  │${RESET}                                                          ${ACCENT}│${RESET}"
  echo -e "${ACCENT}  ╰──────────────────────────────────────────────────────────╯${RESET}"
  echo
}
...
SMTP_FROM_EMAIL="" SMTP_FROM_NAME="Awesome.ai"
...
step_mode() {
  ...
  _line "How are you deploying Awesome.ai?"
  _choose "Select mode" \
...
step_llm() {
  ...
  _line "Awesome.ai uses an LLM for extraction, chat, and workflows."
...
step_ocr() {
  ...
  _line "An OCR service lets Awesome.ai extract text from scanned / image PDFs."
...
step_email() {
  ...
  if _confirm "Configure SMTP email?" "n"; then
    ...
    _prompt "From display name" "Awesome.ai"
...
step_admin() {
  ...
  _line "Create the first administrator account for Awesome.ai."
  _blank
...
generate_env() {
  ...
  cat > "$env_file" <<EOF
# ============================================================
# Awesome.ai — generated by deploy.sh on $(date)
# ============================================================
...
success_screen() {
  ...
  echo -e "  ${ACCENT}╭──────────────────────────────────────────────────────────╮${RESET}"
  echo -e "  ${ACCENT}│${RESET}                                                          ${ACCENT}│${RESET}"
  echo -e "  ${ACCENT}│${RESET}   ${GREEN}${BOLD}🎉  Awesome.ai is deployed and ready!${RESET}                 ${ACCENT}│${RESET}"
  echo -e "  ${ACCENT}│${RESET}                                                          ${ACCENT}│${RESET}"
...
main() {
  _banner
  echo -e "  Welcome to the Awesome.ai deployment wizard."
